...
def plot(fit_pars):
    ...
    plot_ps_ths(mass_ax, 1, r"$m_{\rm PS} $", 0.8, scale=fps_scale)
    plot_ps_ths(mass_ax, 2, r"$2m_{\rm PS}$", 0.6, scale=fps_scale)
    plot_ps_ths(mass_ax, 3, r"$3m_{\rm PS}$", 0.4, scale=fps_scale)
    plot_ps_ths(mass_ax, 4, r"$4m_{\rm PS}$", 0.3, scale=fps_scale)
