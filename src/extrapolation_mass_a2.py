...
from .fitting import global_meson_fit, mass_square_a2_fit_form, split_means_samples
from .extrapolation_common import get_args, get_data, dump_fit_result


def main():
    args = get_args(channels=["ps", "v", "t", "av", "at", "s"])
    ...
    fit_result = global_meson_fit(
        partial(mass_square_a2_fit_form, lat_a=lat_a_means),
