...
rule gevp_meson_mass:
    ...
    shell:
        ...
        " --n_smear_min {params.metadata.n_smear_min} --n_smear_max {params.metadata.n_smear_max}"
        " --n_smear_diff {params.metadata.n_smear_diff} --epsilon {params.metadata.f_epsilon} "
